...
export const Header = ({
  ...
  return (
    <header className="max-h-[90vh] ">
      <div className=" mx-auto mb-20 flex max-w-4xl items-center justify-between pt-8 ">
        <Link to="/">
      ...
      <section className="mx-auto mb-20 max-h-screen max-w-4xl space-y-4 md:space-y-8">
        <div>
          <h2 className="font-primary mb-2 font-semibold uppercase tracking-widest text-slate-700 opacity-30">
            // {subtitle}
          </h2>
          <h2
            className={`font-heading text-5xl leading-[1.25] tracking-tight text-darktext md:text-7xl ${
