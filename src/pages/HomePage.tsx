  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl px-8">
        ...
        <div className="divide-y divide-stone-300" id="projects">
          <ProjectSection
            title="Arkoko"
            technologies={[
              "React",
      ...
      <footer className="min-w-screen bg-accent tracking-tighter text-primary ">
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-between gap-4 py-10 px-8 md:flex-row">
          ...
          <ul className="flex items-center justify-center gap-4 font-inter text-sm font-light uppercase ">
            <a href="#projects">
              <li className="transition-all hover:underline">Projects</li>
            </a>

            <Link to="/about">
              <li className="transition-all hover:underline">About</li>
            </Link>
            <Link to="/contact">
              <li className="transition-all hover:underline">Contact</li>
            </Link>
          </ul>
