...
export const Snippits = () => {
  return (
    <div className="min-h-screen  bg-primary font-normal text-darktext">
      ...
      <main>
        <ProductConception
          paragraph="Snippits was created with the objective to help alleviate the
          ...
          paragraph2="Many games have a lot of online resources to help new and
                ...
                lack certain features that others have and vice-versa. Snippits
        ...
        <Challenges
          ...
          secondHeading="Snippits as a whole"
          ...
          secondParagraphTwo="Determining how I should tackle each challenge proves
                    difficult since every feature of Snippits is so unique that
                    ...
                    Snippits as my main passion project."
        />
